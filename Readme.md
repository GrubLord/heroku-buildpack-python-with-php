...
This is a [Heroku buildpack](http://devcenter.heroku.com/articles/buildpacks) for PHP apps that include Python components.
It uses [virtualenv](http://www.virtualenv.org/) and [pip](http://www.pip-installer.org/), and also installs PHP and Apache.
...
This is based entirely on heroku-buildpack-php and heroku-buildpack-python, also available on GitHub. I claim no ownership of the code, and this is released entirely for convenience.